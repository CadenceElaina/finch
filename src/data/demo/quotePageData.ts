...
export const DEMO_QUOTE_PAGE_DATA: Record<string, QuotePageData> = {
  AAPL: {
    ...
    quoteSidebarData: {
      ...
      fiftyTwoWeekRange: "$169.21 - $260.10",
      marketCap: "3.68T",
      volume: "54.32M",
  ...
  MSFT: {
    ...
    quoteSidebarData: {
      ...
      fiftyTwoWeekRange: "$366.50 - $468.35",
      marketCap: "3.09T",
      volume: "22.18M",
  ...
  GOOGL: {
    ...
    quoteSidebarData: {
      ...
      fiftyTwoWeekRange: "$150.22 - $207.05",
      marketCap: "2.28T",
      volume: "28.40M",
  ...
  NVDA: {
    ...
    quoteSidebarData: {
      ...
      fiftyTwoWeekRange: "$75.61 - $153.13",
      marketCap: "3.22T",
      volume: "312.60M",
  ...
  TSLA: {
    ...
    quoteSidebarData: {
      ...
      fiftyTwoWeekRange: "$138.80 - $488.54",
      marketCap: "1.09T",
      volume: "98.75M",
  ...
  META: {
    ...
    quoteSidebarData: {
      ...
      fiftyTwoWeekRange: "$414.50 - $740.91",
      marketCap: "1.72T",
      volume: "16.35M",
